...
public class MenuUsuario extends JFrame {
	...
	public MenuUsuario() {
		...
		lblNewLabel_2.setIcon(new ImageIcon(Objects.requireNonNull(MenuUsuario.class.getResource("/images/aH-150px.png"))));
		...
		labelRegistro.setIcon(new ImageIcon(Objects.requireNonNull(MenuUsuario.class.getResource("/images/reservado.png"))));
		...
		lblBusquedaDeReservas.setIcon(new ImageIcon(Objects.requireNonNull(MenuUsuario.class.getResource("/images/pessoas.png"))));
